...
<div class="container">
    <div class="page-inner">
    	...
    	<div class="">
			<h2 class="text-uppercase fw-bold mb-3">Cập Nhật Phim</h2>
		</div>

		<form class="row g-3 needs-validation" method="post" 
				enctype="multipart/form-data" 
				action="${pageContext.request.contextPath}/admin/anime/update"
				novalidate>
			<div class="col-md-6">
				<div class="row g-3">
					<div class="col-md-12">
			...
			<div class="col-md-6">
				<div class="row g-3">
					...
					<div class="col-12">
						...
						<input type="file" class="form-control" id="poster" name="poster" accept=".jpg,.png,.webp"> 
						<input type="hidden" name="oldPoster" value="${anime != null ? anime.poster : ''}" required>
