...
<div class="container">
    <div class="page-inner">
		...
		<form action="${pageContext.request.contextPath}/admin/episode/insert" method="post" class="needs-validation" novalidate>
                <div class="mb-3">
                ...
                <div class="d-flex gap-3">
                    <button type="submit" class="btn btn-success">Thêm Tập Phim</button>
